...
| [json.md](json.md)                       | The parser, its limits, number output and key-sorted form.                                                            | You care about key order, number spelling or hashing.               |
...
- [schemas/](../schemas/) — base JSON Schema templates for the documents
  (see [ide-schemas.md](ide-schemas.md)).
